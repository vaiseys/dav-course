...
Each row represents a match. We have the home team, away team, the score (in terms of difference), and the categorical result. That last one is `aw` when the away team wins, `d` when there's a draw, and `hw` when the home team takes the points. \>\>\>\>\>\>\> 3bff384 (My data)