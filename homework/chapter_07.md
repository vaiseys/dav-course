...
Here, we are going to practice and reinforce some of the ideas that we encountered in [chapter 7](https://moderndive.com/v2/sampling.html) and [chapter 8](https://moderndive.com/v2/confidence-intervals.html).

Sampling is crucial for understanding any type of data analysis. When you are presented with brand new set of data, it is always useful to think: what groups or populations am I capturing in this data? To what groups or populations can I extrapolate insights I draw from this data? Do I have enough data? To answer these questions, it is essential to grasp sampling; to think about how features of a population might (or might not) make their way to our spreadsheets.
...
We will use the `rep_sample_n()` function from the **moderndive** package.

Using this function, take 50 samples of 25 winners each. Plot your results. Be sure to add the mean proportion of your samples and the true proportion we calculated above.

> HINT: `summarize()` is going to be useful here.
